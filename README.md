...
## Description
This site provides users with information about movies, on sale tickets and most popular movies. Its main aim is to help users discover new films and gain direct access to cinema sites for tickets. The goal of the site also includes the platform giving users a cinema feel to it to enhance experience.
...
I would also be more clear on how I would use bootstrap and not treat it as an after thought because that was what caused the overriding of many elements and styles.

## What to improve on
I would improve on my knowledge and usage of bootstrap more to be more flexible.

## General Notes
I'm happy with my current design. There is always room for improvement but this is a solid design. Took it right out of my UI portfolio and this looks better than I expected. This took many additions, trial and error to get to where it is now but it was a good learning curve for me.

## Github link
https://github.com/soubyron/web-design-assignment
